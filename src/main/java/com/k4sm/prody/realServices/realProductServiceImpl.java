...
public class realProductServiceImpl {
  ...
  private final realProductServiceInterface productserviceInterface;

  private final categoryServiceInterface categoryServiceInterface;

  public realProductServiceImpl(
      realProductServiceInterface realProductServiceInterface,
  ...
  public ProductEntity createProduct(RealCreateProductDTO product) {
    ...
    Optional<CategoryEntity> categoryVal =
        this.categoryServiceInterface.findCategoryEntityByName(product.getCategory());
