...
public class fakeProductService {
  ...
  public List<Product> getAllProducts() {
    ...
    ParameterizedTypeReference<List<FakeProductDTO>> responseType =
        new ParameterizedTypeReference<>() {};
    ResponseEntity<List<FakeProductDTO>> responseEntity =
  ...
  public Product getProductById(int id) {
    ...
    FakeProductDTO fakeStoreProductDTO = restTemplate.getForObject(url, FakeProductDTO.class);
  ...
  public List<Product> getProductsByCategory(String category) {
    ...
    if (fakeStoreProductDTOS.isEmpty()) {
      throw new ProductNotFoundException(
          String.format("products with catagory: %s not found", category));
    }
  ...
  public Product createProduct(Product product) {
    ...
    restTemplate.postForObject(url, fakeStoreProductDTO, FakeProductDTO.class);
  ...
  public Product updateProduct(int id, Product product) {
    ...
    FakeProductDTO updatedProduct =
        restTemplate
            .exchange(
                url,
                HttpMethod.PUT,
                new HttpEntity<FakeProductDTO>(productToFakeProduct(product)),
