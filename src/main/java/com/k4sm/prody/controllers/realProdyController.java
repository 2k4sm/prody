...
public class realProdyController {
  @Autowired private realProductServiceImpl realProductService;
  @Autowired private categoryService categoryService;

  private final ModelMapper modelMapper;

  public realProdyController(
      realProductServiceImpl realProductService, categoryService categoryService) {
  ...
  public Product updateProduct(
      @PathVariable("id") int id, @RequestBody RealCreateProductDTO product) {
